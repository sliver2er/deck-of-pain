...
| 컴포넌트 | 적용된 TDS |
|----------|-----------|
| `CardContainer.tsx` | `Text` |
| `ProgressIndicator.tsx` | `Text`, `adaptive` colors |
| `RestTimer.tsx` | `Text`, `Button`, `adaptive` colors |
...
### Phase 4 진행 기록 (2025-01-12)

**생성된 파일:**
| 파일 | 설명 | TDS 컴포넌트 |
|------|------|-------------|
| `src/pages/LandingPage.tsx` | 난이도 선택 + 시작 | `Text`, `Button`, `FixedBottomCTA`, `Post.Paragraph` |
